...
from pytorch3d.transforms.rotation_conversions import axis_angle_to_matrix, matrix_to_rotation_6d, rotation_6d_to_matrix, matrix_to_axis_angle, axis_angle_to_matrix
...
class TCMRLoss(nn.Module):
    ...
    def forward(
        ...
        # # axis -> 6d -> axis
        # real_pose = real_pose.reshape(-1, 24, 3)
        # real_pose = matrix_to_axis_angle(rotation_6d_to_matrix(matrix_to_rotation_6d(axis_angle_to_matrix(real_pose))))
